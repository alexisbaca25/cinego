import 'package:cinemapedia/presentation/provider/comments.dart';
    ...
    return Column(
      ...
      children: [
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                leading: CircleAvatar(
                  // SOLUCIÓN: Verificamos si no está vacío antes de pedir la letra [0]
                  child: Text(
        ...
        Padding(
          ...
          child: _CommentInput(movieId: movieId),
        ),
